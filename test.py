...
def get_joblist(id: str, session=None)->list:
    url = 'https://www.104.com.tw/company/ajax/joblist/12swdh0w?&pageSize=40'
    #url = 'https://www.104.com.tw/company/ajax/content/12swdh0w'
    #url = 'https://www.104.com.tw/company/12swdh0w?tab=job'
    '''
    ...
    headers = {'user-agent': USER_AGENT, 'referer': 'https://www.104.com.tw/'}
    s = requests.Session()
    req = s.get(url, headers = headers)
    #print(req.text)
    #text = req.text.replace('\\/', '/')
    #result = bytes(req.text, 'ascii').decode('unicode-escape')
    #print(result)
...
if __name__ == '__main__':
    id = '12swdh0w'
    print(get_company_info(id))
    print(get_job_count(id))